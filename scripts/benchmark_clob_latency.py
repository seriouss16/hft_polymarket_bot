...
async def benchmark(runs: int = 10, duration_sec: float = 60.0, output_dir: str = "hft_bot/reports/banch_lag") -> dict:
...
def main():
    ...
    stats = asyncio.run(benchmark(runs=args.runs, duration_sec=args.duration, output_dir=args.output))
