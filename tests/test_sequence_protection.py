...
def test_sequence_protection_price_change():
    ...
    msg1 = {
        ...
        "sequence": 101,
        "price_changes": [{"asset_id": asset_id, "price": "0.50", "size": "15", "side": "BUY"}],
    }
    ...
    msg2 = {
        ...
        "price_changes": [{"asset_id": asset_id, "price": "0.50", "size": "20", "side": "BUY"}],
    }
...
def test_sequence_protection_best_bid_ask():
    ...
    msg1 = {"event_type": "best_bid_ask", "asset_id": asset_id, "sequence": 102, "best_bid": "0.51", "best_ask": "0.54"}
    ...
    msg2 = {"event_type": "best_bid_ask", "asset_id": asset_id, "sequence": 101, "best_bid": "0.52", "best_ask": "0.53"}
